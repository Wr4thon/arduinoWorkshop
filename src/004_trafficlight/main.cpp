...
void trafficLightAdvanced::setup(void)
{
...
void trafficLightAdvanced::loop(void)
{
  cycleCurrentStep++;
...
void trafficLightAdvanced::applyCycle(trafficLightCycle cycle)
{
...
void trafficLightAdvanced::setLightState(lightState state)
{
